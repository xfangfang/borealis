...
set(ZIG_RC_64 "${ZIG_TOOLS}/zig-rc-x86_64.sh")
set(ZIG_RC_32 "${ZIG_TOOLS}/zig-rc-x86.sh")
...
if (ZIG_TARGET_OS STREQUAL "Windows")
    find_program(WINDRES_EXECUTABLE NAMES windres x86_64-w64-mingw32-windres)
    if(NOT WINDRES_EXECUTABLE)
        message(FATAL_ERROR "windres not found")
    endif()
    configure_file(${ZIG_TOOLS_IN}/zig-rc-x86_64.sh.in ${ZIG_RC_64} @ONLY)
    configure_file(${ZIG_TOOLS_IN}/zig-rc-x86.sh.in ${ZIG_RC_32} @ONLY)
endif ()