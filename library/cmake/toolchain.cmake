...
elseif(PLATFORM_PSV)
    ...
    add_compile_options(-Wno-error=pedantic -Wno-psabi)
elseif(PLATFORM_PS4)
    ...
    if (NOT DEFINED ENV{OPENORBIS})
        message(FATAL_ERROR "Please set OPENORBIS in your environment. export OPENORBIS=<path to>/openorbis")
    endif ()
    set(OPENORBIS $ENV{OPENORBIS} CACHE BOOL "OPENORBIS")
    set(CMAKE_TOOLCHAIN_FILE "${OPENORBIS}/cmake/ps4.cmake" CACHE PATH "toolchain file")
    add_definitions(-DPS4 -D__PS4__)
elseif(PLATFORM_PS5)
    message(STATUS "building for PS5")
    set(USE_SDL2 ON)
    set(USE_GLFW OFF)
    set(USE_GL3 ON)
    if (NOT DEFINED ENV{PS5_PAYLOAD_SDK})
        message(FATAL_ERROR "Please set PS5_PAYLOAD_SDK in your environment. export PS5_PAYLOAD_SDK=<path to ps5 payload sdk>")
    endif ()
    set(CMAKE_TOOLCHAIN_FILE "$ENV{PS5_PAYLOAD_SDK}/toolchain/prospero.cmake" CACHE PATH "toolchain file")
    add_definitions(-DPS5 -D__PS5__)
